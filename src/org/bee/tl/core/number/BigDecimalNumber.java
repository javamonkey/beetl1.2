...
public class BigDecimalNumber extends GeneralNumber {
	...
	public String toString() {
		...
		// String s =
		// this.bigNum==null?this.num.toString():this.bigNum.toString();
		// // if(s.indexOf(".") > 0){
	...
	public BeeNumber divide(Number n) {
		...
		if (n instanceof BigDecimalNumber) {
			BigDecimalNumber a1 = (BigDecimalNumber) n;
			return new BigDecimalNumber(this.bigNum.divide(a1.get(), scale,
					roundingMode));
		} else {
			BigDecimal a1 = make(n);
			return new BigDecimalNumber(this.bigNum.divide(a1, scale,
					roundingMode));
		}
