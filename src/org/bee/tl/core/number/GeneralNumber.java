...
public class GeneralNumber extends BeeNumber {
	...
	public GeneralNumber add(Number n) {
		...
		return new GeneralNumber(trim(num.doubleValue() + n.doubleValue(), num,
				n));
	}
	...
	public BeeNumber min(Number i) {
		return new GeneralNumber(this.trim(num.doubleValue() - i.doubleValue(),
				num, i));
	}
	...
	public BeeNumber multiply(Number d) {
		// TODO Auto-generated method stub
		return new GeneralNumber(this.trim(num.doubleValue() * d.doubleValue(),
				num, d));
	}
