...
public class BasicExpTestCase extends BasicTestCase {
	...
	public void testDoubleAdd() throws IOException, BeeException {
		...
		String str = t.getTextAsString();
		this.assertEquals(this.getFileContent("/exp/double_add_expected.html"),
				str);
	}
	...
	public void testDoubleMinus() throws IOException, BeeException {
		...
		String str = t.getTextAsString();
		this.assertEquals(
				this.getFileContent("/exp/double_minus_expected.html"), str);
	}

	public void testDoubleMutilply() throws IOException, BeeException {
		Template t = this.gt
				.getFileTemplate("/exp/double_mutiple_template.html");
		String str = t.getTextAsString();
		this.assertEquals(
				this.getFileContent("/exp/double_mutiple_expected.html"), str);
	}

	public void testDouble2Mutilply() throws IOException, BeeException {
		Template t = this.gt
				.getFileTemplate("/exp/double2_mutiple_template.html");
		t.set("j", 0.1d);
		User user = new User();
		user.setAge(15);
		t.set("user", user);
		...
		this.assertEquals(
				this.getFileContent("/exp/double2_mutiple_expected.html"), str);
	}

	public void testDoubleFunMutilply() throws IOException, BeeException {
		Template t = this.gt
				.getFileTemplate("/exp/double_fun_mutiple_template.html");
		...
		this.assertEquals(
				this.getFileContent("/exp/double_fun_mutiple_expected.html"),
				str);
	}
	...
	public void testDoubleDiv() throws IOException, BeeException {
		...
		String str = t.getTextAsString();
		this.assertEquals(this.getFileContent("/exp/double_div_expected.html"),
				str);
	...
	public void testStringAdd() throws IOException, BeeException {
		...
		String str = t.getTextAsString();
		this.assertEquals(this.getFileContent("/exp/string_add_expected.html"),
				str);
	...
	public void testIntDiv() throws IOException, BeeException {
		...
		String str = t.getTextAsString();
		this.assertEquals(this.getFileContent("/exp/int_div_expected.html"),
				str);
	}

	public void testSimpleCase() throws IOException, BeeException {

		Template t = this.gt.getFileTemplate("/exp/simple_case_template.html");
		String str = t.getTextAsString();
		t = this.gt.getFileTemplate("/exp/simple_case_template.html");
		str = t.getTextAsString();
		this.assertEquals(
				this.getFileContent("/exp/simple_case_expected.html"), str);
	}
}
