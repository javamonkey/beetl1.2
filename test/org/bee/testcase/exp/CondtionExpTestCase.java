...
public class CondtionExpTestCase extends BasicTestCase {
	...
	public void testBasic() throws IOException, BeeException {
		...
		this.assertEquals(this.getFileContent("/exp/condition_expected.html"),
				str);
	}
	...
	public void testRawBasic() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/exp/conditionObject_template.html");
		Map map = new HashMap();
		map.put("size", 16);
		map.put("id", "34544545");
		...
		String str = t.getTextAsString();
		this.assertEquals(
				this.getFileContent("/exp/conditionObject_expected.html"), str);
	...
	public void testRawArth() throws IOException, BeeException {
		...
		String str = t.getTextAsString();
		this.assertEquals(this.getFileContent("/exp/arthObject_expected.html"),
				str);
