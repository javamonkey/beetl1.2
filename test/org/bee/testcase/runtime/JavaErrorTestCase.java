...
public class JavaErrorTestCase extends BasicTestCase {
	...
	public void testSimple() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/runtime/format_notfound_template.html");
	...
	public void testFunctionError() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/runtime/function_error_template.html");
	...
	public void testTagError() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/runtime/tag_error_template.html");
	...
	//
	// Template t =
	// this.gt.getFileTemplate("/runtime/virtual_error_template.html");
	...
	public void testNativeError() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/runtime/native_error_template.html");
