...
public class HtmlTagTestCase extends BasicTestCase {
	...
	public void testSimple() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/htmltag/simpletag_template.html");
		String str = t.getTextAsString();
		Assert.assertEquals(
				this.getFileContent("/htmltag/simpletag_expected.html"), str);
		// 第二次预编译
	...
	public void testNested() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/htmltag/nestedtag_template.html");
		String str = t.getTextAsString();
		Assert.assertEquals(
				this.getFileContent("/htmltag/nestedtag_expected.html"), str);
		// 第二次预编译
	...
	public void testUnformat() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/htmltag/unformated_template.html");
		String str = t.getTextAsString();
		Assert.assertEquals(
				this.getFileContent("/htmltag/unformated_expected.html"), str);
		// 第二次预编译
	...
	public void testTagFunction() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/htmltag/tagfunction_template.html");
		String str = t.getTextAsString();
		Assert.assertEquals(
				this.getFileContent("/htmltag/tagfunction_expected.html"), str);
		// 第二次预编译
	...
	public static class CommentTag extends GeneralBeetlTag {
		...
		protected void makeOutput() {
			try {
				this.writer.write("//");
				if (this.isByteContent())
					this.writer.write(this.inputBytes);
				else
