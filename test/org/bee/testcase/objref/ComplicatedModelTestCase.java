...
public class ComplicatedModelTestCase extends BasicTestCase {
	...
	public void testSimple() throws IOException, BeeException {
		...
		Assert.assertEquals(this.getFileContent("/objref/order_expected.html"),
				str);
		...
		Assert.assertEquals(
				this.getFileContent("/objref/vipOrder_expected.html"), str);
		...
		str = t.getTextAsString();
		Assert.assertEquals(
				this.getFileContent("/objref/commonOrder_expected.html"), str);
