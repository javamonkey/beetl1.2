...
public class CommentTestCase extends BasicTestCase {
	...
	public void testSimple() throws IOException, BeeException {
		...
		Assert.assertEquals(
				this.getFileContent("/comment/comment1_expected.html"), str);
		// 第二次预编译
	...
	// String str = t.getTextAsString();
	// Assert.assertEquals(this.getFileContent("/comment/comment2_expected.html"),
	// str);
	// //第二次预编译
	...
	// String str = t.getTextAsString();
	// Assert.assertEquals(this.getFileContent("/comment/comment3_expected.html"),
	// str);
	// //第二次预编译
