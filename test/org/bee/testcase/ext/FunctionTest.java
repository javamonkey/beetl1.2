...
public class FunctionTest extends BasicTestCase {
	...
	// str = t.getTextAsString();
	//
	// Assert.assertEquals(this.getFileContent("/ext/split_expected.html"),
	// str);
	//
	// }
	...
	public void testWrapper() throws IOException, BeeException {
		...
		String str = t.getTextAsString();
		Assert.assertEquals(this.getFileContent("/ext/wrapper_expected.html"),
				str);
	}
	...
	class SplitFunction implements Function {
		...
		public String[] call(Object[] paras, Context ctx) {
			...
			if (paras.length != 2) {
				...
				if (paras.length == 2) {
					String[] list = paras[0].toString().split(
							paras[1].toString());
					return list;
				}

				throw new RuntimeException(
						"Parse split Error,Args String,String ");
			}
		}
