...
public class FormatTest extends BasicTestCase {
	...
	public void testFormat() throws IOException, BeeException {
		...
		Assert.assertEquals(this.getFileContent("/ext/format_expected.html"),
				str);
		// 第二次预编译
	...
	public void testDefaultFormat() throws IOException, BeeException {
		...
		Template t = this.gt
				.getFileTemplate("/ext/defaultformat_template.html");
		String str = t.getTextAsString();
		Assert.assertEquals(
				this.getFileContent("/ext/defaultformat_expected.html"), str);
		// 第二次预编译
